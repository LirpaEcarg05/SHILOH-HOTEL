        ...
        <form class="form-horizontal well span6" action="controller.php?action=edit" enctype="multipart/form-data" method="POST">
          <div class="container">
            ...
            <div class="form-group mb-3" style="font-size: 20px;">
              <div class="col-lg-15">
                <label class="col-lg-15 control-label" for="ROOM">Name:</label>
            ...
            <div class="form-group mb-3">
              <div class="col-lg-15">
                <label class="col-lg-15 control-label" for="ACCOMID">Accomodation:</label>
            ...
            <div class="form-group mb-3">
              <div class="col-lg-15">
                <label class="col-lg-15 control-label" for="ROOMDESC">Description:</label>
            ...
            <div class="form-group mb-3">
              <div class="col-lg-15">
                <label class="col-lg-15 control-label" for="NUMPERSON">Number of Person:</label>
            ...
            <div class="form-group mb-3">
              <div class="col-lg-15">
                <label class="col-lg-15 control-label" for="PRICE">Price:</label>
            ...
            <!--   <div class="form-group mb-3">
            <div class="col-lg-15">
              <label class="col-lg-15 control-label" for=
         ...
         -->
            <div class="form-group mb-3">
              <div class="col-lg-15">
                <label class="col-lg-15 control-label" for="image">Upload Image:</label>
            ...
            <div class="form-group mb-3">
              <div class="col-lg-15">
                <label class="col-lg-15 control-label" for="idno"></label>
