  ...
  <div class="super_container">
    <header class="header">
      <div class="header_content d-flex flex-column align-items-center justify-content-lg-end justify-content-center">
        ...
        <h1 style="font-family: 'Times New Roman', Times, serif; font-size:60px;"> SHILOH HOTEL</h1>
        <h3 style="font-family: 'Times New Roman', Times, serif; font-size:25px;" class="font-italic">Stay with us, and feel like home</h3>
        <br><br>
        <!-- Main Nav -->
        <nav class="main_nav">
    ...
    <div class="logo_overlay">
      <div class="logo_overlay_content d-flex flex-column align-items-center justify-content-center">
        <div class="logo"><a href="#"><img src="<?php echo WEB_ROOT; ?>images/shilologo.png" alt=""></a></div>
      </div>
    </div>
    ...
    <div class="home">
      ...
      <div class="home_container d-flex flex-column align-items-center justify-content-center">
        <br><br><br><br>
        <div class="home_title text-secondary">
          <h1>Book Your Stay</h1>
        </div>
        <div class="home_text text-center">Stay now, feel like home and with us you will meet your highest expectation.</div>
    ...
    <!-- Footer -->
    <footer class="footer">
      <div class="parallax_background parallax-window" data-parallax="scroll" style="opacity: 0.5;" data-image-src="<?php echo WEB_ROOT; ?>images/footer.jpg" data-speed="0.8"></div>
      <div class="container">
        <div class="row">
          <div class="col">
            <div class="footer_logo text-center">
              <!-- <a href="#"><img src="images/shilohlogo.png" alt=""></a> -->
              <h2 style="font-family: 'Times New Roman', Times, serif; font-size:50px;">Shiloh Hotel</h2>
              <h6 style="font-family: 'Times New Roman', Times, serif; font-size:15px;" class="font-italic">Stay with us, and feel like home</h6>
            </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-4 footer_col">
                  <div class="footer_info d-flex flex-column align-items-center justify-content-start">
                    <div class="text-center">
                      <div>Address:</div>
                      <div>Samjung Building, Nasipit Road Talamban, Cebu City</div>
                    </div>
                  </div>
                </div>
                <div class="col-lg-4 footer_col">
                  <div class="footer_info d-flex flex-column align-items-lg-start align-items-center justify-content-start">
                    <div class="text-center">
                      <div>Mail:</div>
                      <div>shilohHotel@contact.com</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="footer_bar text-center">
              ...
              </script> All rights reserved <i class="fa fa-heart-o" aria-hidden="true"></i> by April Grace Diez and Rhea Amancio
            </div>
          </div>
        </div>
      </div>
